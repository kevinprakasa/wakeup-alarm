...
public class DayPickerDialog extends AppCompatDialogFragment {
    ...
    private void processValue() {
        ...
        if (weekdaysCheck.isChecked()) {
            daysPicked.put(-1,"Weekday");
        } else {
            if (day1Check.isChecked()) daysPicked.put(1,"Mon");
            if (day2Check.isChecked()) daysPicked.put(2,"Tue");
            if (day3Check.isChecked()) daysPicked.put(3,"Wed");
            if (day4Check.isChecked()) daysPicked.put(4,"Thu");
            if (day5Check.isChecked()) daysPicked.put(5,"Fri");
        }

        if (weekendCheck.isChecked()) {
            daysPicked.put(0,"Weekend");
        } else {
            if (day6Check.isChecked()) daysPicked.put(6,"Sat");
            if (day7Check.isChecked()) daysPicked.put(7,"Sun");
        }
