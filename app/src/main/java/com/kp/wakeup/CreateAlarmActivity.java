...
import com.kp.wakeup.ContentProvider.AlarmContentProvider;
import com.kp.wakeup.Dialog.DayPickerDialog;
import com.kp.wakeup.Dialog.SnoozableDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(ALARM_TIME)) {
            ...
            daysPicker.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(CreateAlarmActivity.this, "Sorry you can't edit the day of this alarm", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void applySnoozeChoice(int checkedId) {
        ...
        switch (checkedId) {
            case R.id.zeroMin:
                ...
                break;
            case R.id.fiveMin:
                snoozeMinText = "5 mins";
                choosedSnooze = 5;
                break;
            case R.id.tenMin:
                snoozeMinText = "10 mins";
                choosedSnooze = 10;
                break;
            case R.id.fifteenMin:
                snoozeMinText = "15 mins";
                choosedSnooze = 15;
                break;
            case R.id.twentyMin:
                snoozeMinText = "20 mins";
                choosedSnooze = 20;
                break;
